...
<section class="bg-white flex flex-col items-center justify-center text-center my-10 grow">
	<h2 class="text-4xl md:text-5xl venetian-red-text font-extrabold mb-4">Login to Diese</h2>
	...
	<p class="mt-4 text-gray-600">Don't have an account? <a href="/register.php" class="text-venetian-red hover:underline">Register here</a></p>
</section>
